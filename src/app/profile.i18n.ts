...
export const PROFILE_ES: ProfileData = {
  personalInfo: {
...
export const PROFILE_EN: ProfileData = {
  ...
  education: [
    ...
    },
    {
      ...
      activities:
        'IT mentor at Microsoft Virtual Academy workshop (2014); outstanding student in Computer Science (2013–2014).'
    },
    {
      institution: 'Cisco Networking Academy',
      degree: 'CCNA: Network Fundamentals, Computer Engineering'
    },
    {
      institution: 'Cisco Networking Academy',
      degree: 'IT Essentials: PC Hardware and Software, Computer Engineering'
    }
  ],
  skills: [
    'C#',
